...
INSERT INTO `ac_balance` (`idparty`, `title`, `medium`, `balance`, `updated_at`)
VALUES (0, 'Office Cash balance', 0, 0.00, '2020-10-18 01:51:41'),
...
INSERT INTO `mesurment_unite` (`idunite`, `unite`)
VALUES (1, 'BAG'),
       (2, 'FEET'),
       (4, 'GRAM'),
       (3, 'KG'),
...
(
  ...
  DEFAULT CHARSET = latin1 COMMENT ='0 supplier 1 buyer 2 other';
...
--
ALTER TABLE `mesurment_unite`
    MODIFY `idunite` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 8;
