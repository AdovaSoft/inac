...
<br/><a  id='showAll' href='index.php?e=" . $encptid . "&page=accounts&sub=purchase_expense&party=" . $_GET['pt'] . "&pay_type=-1&cost=" . ($_GET['cost'] - $_GET['d']) . "' class='button'>Add Purchase Expense</a>";
        } elseif ($_GET['say'] == 2) {
