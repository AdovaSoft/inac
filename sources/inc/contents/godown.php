...
<div id="bigmenu">
  ...
  <a href="index.php?e=<?= $encptid ?>&&page=stock&&sub=date_report_godown">Datewise Godown</a>
  <a href="index.php?e=<?= $encptid ?>&&page=stock&&sub=godown_all">Godown All Products</a>
  <a href="index.php?e=<?= $encptid ?>&&page=stock&&sub=godown_raw">Godown Raw Matarials</a>
