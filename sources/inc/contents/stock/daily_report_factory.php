...
if (isset($_GET['group']) == 1) {
    ...
    $tti = $tto = 0;
    if ($n > 0) {
        echo "<a href='index.php?e=" . $encptid . "&page=stock&&sub=daily_report_factory&&date=" . $date . "' class='button'><b> Show Just Datewise </b></a>";
        echo "<a href='index.php?e=" . $encptid . "&page=stock&&sub=daily_report_factory&&date=" . $date . "&&group=2' class='button'><b> Group Unitwise </b></a>";
    ...
    if ($n > 0) {
        echo "<a href='index.php?e=" . $encptid . "&page=stock&&sub=daily_report_factory&&date=" . $date . "' class='button'><b> Show Just Datewise </b></a>";
        echo "<a href='index.php?e=" . $encptid . "&page=stock&&sub=daily_report_factory&&group=1&&date=" . $date . "' class='button'><b> Group Productwise </b></a>";
