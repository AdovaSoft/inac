<h1>Factory Finished Product Stock Report</h1>
<br/>
<?php
...
echo "<a id='printBox'  href='print.php?e=" . $encptid . "&page=stock&&sub=factory_finished' class='button' target='_blank'><b> Print </b></a>";
