...
<div id="bigmenu">
  ...
  <a href="index.php?e=<?php echo $encptid ?>&&page=accounts&&sub=report">Accounts Report</a>
  <a href="index.php?e=<?php echo $encptid ?>&&page=accounts&&sub=daily_report">Daily Accounts</a>
</div>