...
<ul class="isolated">
  <li><a href="index.php?e=<?= $encptid ?>&&page=userinfo">User</a>
    <ul>
      ...
      <li><a href="index.php?e=<?php echo $encptid ?>&&page=settings">Settings <img src="images/gear.gif" align="middle" alt="*" /></a></li>
