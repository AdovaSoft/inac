...
WHERE party.idparty = %d AND transaction.id = %d", $party_id, $transaction_id);
        ...
        public function update_party_balance($party_id = 0, $transaction_type = 0, $medium = 0, $amount = 0)
        {
             ...
             * Transaction Type = 1   then plus to party and minus from company
             */
            $party_current_balance = $this->get_custom_select_query(sprintf("SELECT balance FROM ac_balance WHERE idparty = %d AND medium = %d", $party_id, $medium), 1);
